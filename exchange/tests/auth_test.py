...
class AuthZeroOAuth2Test(TestCase):
    ...
    def test_get_user_details_admin(self):
        response = {
            ...
            "username": "testuser",
            "organization": "cn=testuser, OU=People, OU=Unit, OU=DD, O=Example, C=US",
            ...
            "commonname": "testuser",
            "firstname": "testuser",
            "user_metadata": {"name": "testuser", "firstName": "testuser", "lastName": "testuser",},
            "app_metadata": { "SiteRole": 'admin'}
        }
        self.assertTrue('is_active' in self.geo_axis.get_user_details(response))
...
class GeoAxisOAuth2Test(TestCase):
    ...
    def test_user_id(self):
        self.assertEqual('1234', self.geo_axis.get_user_id({'uid': '1234'},{}))
    ...
    def test_get_user_details(self):
        ...
        self.assertTrue('username' in self.geo_axis.get_user_details(response))
